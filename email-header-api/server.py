...
@app.route('/header_analysis', methods=['GET', 'POST'])
def index():
    if request.method == "POST":
        ...
        json_data = {
            "data" : r,"delayed" : delayed,"summary" : summary,
            "n" : email_type_data, "security_headers" : security_headers
        }

        return jsonify(json_data)
    else:
        return jsonify({"error":"Header is required!!"})
